...
var employeeUserModule = function () { };

employeeUserModule.prototype.employeeUserModuleSave = function (request, res) {
	var counter = 0;
		...
		User.findOne({
			...
			user.save(function (err) {
				...
				if(counter === request.length) {
					// res.send('true');
					res.send({data: true, id: uniqueId})
				}	
...
module.exports = new employeeUserModule();